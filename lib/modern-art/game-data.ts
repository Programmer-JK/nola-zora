...
export const ARTISTS: Artist[] = [
  ...
  { id: 'anime',      name: '애니캐릭터', avatar: '🌸', color: '#3B82F6' },
];
...
// 작가별 경매 타입별 카드 수 (원작 준수: 12/11/10/9/8장)
const CARDS_DISTRIBUTION: Record<string, Record<AuctionType, number>> = {
  //                      공개  지정  비밀  한바퀴  더블  = 합계
  'yugioh':     { open: 3, fixed: 3, secret: 3, 'once-around': 2, double: 1 }, // 12
  'digimon':    { open: 3, fixed: 2, secret: 2, 'once-around': 2, double: 2 }, // 11
  'pokemon':    { open: 2, fixed: 2, secret: 2, 'once-around': 2, double: 2 }, // 10
  'indie-game': { open: 2, fixed: 2, secret: 2, 'once-around': 2, double: 1 }, //  9
  'anime':      { open: 2, fixed: 2, secret: 2, 'once-around': 1, double: 1 }, //  8
};
