          ...
          <div>
            ...
            <div className="flex gap-2 mb-3">
              <input
                ...
                className="flex-1 bg-white border border-amber-300/60 rounded-xl px-4 py-2.5 text-amber-950 text-sm outline-none focus:border-amber-500 transition-colors placeholder:text-amber-700"
              />
              <button
                onClick={addMember}
